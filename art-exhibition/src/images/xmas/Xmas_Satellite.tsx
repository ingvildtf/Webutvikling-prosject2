...
import { ReactComponent as xmasSatellite } from '../xmas/xmas_satellite.svg'
...
const StyledXmasSatellite = styled(xmasSatellite)`
  .sat {
...
class SatelliteXmasInstallation extends React.Component {
  render() {
    return (
      <div>
        <StyledXmasSatellite />
...
export default SatelliteXmasInstallation
